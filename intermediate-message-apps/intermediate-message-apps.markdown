...
In Chapter 5, you saw how to build apps containing custom stickers for use in Messages. In this chapter, you'll learn how to send fully custom, updatable messages.

You're going to build a game called **WenderPic**, where one player tries to draw something with a limited supply of ink, and their opponent tries to guess what it is. Drawings and guesses all travel via iMessage.
